        ...
        try {
            $validated = $request->validate(
                [
                    ...
                    'bank1_branch' => 'nullable|string|max:255',
                    'bank1_account_no' => 'nullable|string|max:100',
                    'bank2_name' => 'nullable|string|max:255',
                    'bank2_branch' => 'nullable|string|max:255',
                    'bank2_account_no' => 'nullable|string|max:100',
