...
export default function CustomerForm({ 
 formData,
  setFormData,
  companies = [],       // <-- ADDED DEFAULT
  organisations = [], // <-- ADDED DEFAULT
  allCustMast = [],   // <-- ADDED DEFAULT
  onNext,
  setMessage,
  setIsFormDirty,
}) {
    ...
    try {
      ...
      if (formData.cus_id && formData.cus_id !== 0) {
        ...
        // Create new
        console.log("📦 Sending data to Laravel:", formData);
      ...
      if (error.response && error.response.status === 422) {
        ...
        // Loop over the error messages and format them
        if (validationErrors) {
        ...
        toast.error(errorMessages); // Show detailed errors in a toast

      } else {
        // Generic error
        setMessage(`❌ Failed to save customer. ${error.message || 'Please try again.'}`);
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                onChange={(e) => {
                                    ...
                                    console.log("🟢 Auto-filling data for:", selectedEmp);
                                    ...
                                    setFormData(prev => {
                                        ...
                                        company_id: selectedEmp.company_id || 1, // ✅ added
                                        };
                                        console.log("✅ Updated formData after auto-fill:", updated);
                                        return updated;
                                    });
                                    }
                                }}
