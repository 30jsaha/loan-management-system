                                        ...
                                        {emiSchedule.length > 0 ? (
                                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2">
                                                {emiSchedule.map((tier, tIndex) => {
                                                    ...
                                                    return (
                                                        <div key={tIndex} className={`bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden ${isSmallTable ? 'max-w-fit' : 'w-full'}`}>
                                                                    ...
                                                                    <tbody className="divide-y divide-gray-100">
                                                                        {Object.keys(tier.rows).map((amount) => (
                                                                            <tr key={amount} className="group hover:bg-blue-50 transition-colors">
                                                                                <td className="sticky left-0 z-30 bg-white group-hover:bg-blue-50 p-3 font-bold text-gray-700 border-r border-gray-200 text-right shadow-lg">
                                                                                    {amount}
                                                                                </td>
                                                                                {tier.fns.map((fn) => (
