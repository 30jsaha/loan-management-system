...
export default function Home({ auth, laravelVersion, phpVersion }) {
  ...
  const [amtSliderDisabled, setAmtSliderDisabled] = useState(false);
  const [tenSliderDisabled, setTenSliderDisabled] = useState(false);
